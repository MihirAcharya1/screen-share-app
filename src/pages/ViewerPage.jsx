...
const ViewerPage = () => {
  ...
  const joinRoom = () => {
    ...
    const pc = new RTCPeerConnection({
      ...
      // iceServers: [{ urls: ["stun:bn-turn2.xirsys.com"] },
      // {
      //   username: "TJeUkPhj9ZPlDxawR5yeyfEkFbjX_X-OFaFUln4Ry86f0pO-qqNtE_DV83qBVhp1AAAAAGiJ1GBzaWJ1",
      //   credential: "340591b8-6d1d-11f0-b482-0242ac140004",
